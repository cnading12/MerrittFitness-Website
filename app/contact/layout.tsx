...
export const metadata: Metadata = {
  ...
  description: 'Contact Merritt Wellness at 2246 Irving St, Denver CO 80211 near Sloans Lake. Book yoga classes, sound baths, meditation sessions, and wellness events. Call (303) 359-8337 or email clientservices@merrittwellness.net.',
  ...
  openGraph: {
    ...
    description: 'Get in touch with Merritt Wellness in Sloans Lake, Denver. Book yoga, sound baths, meditation, and wellness events. Call (303) 359-8337.',
