...
export const events: Event[] = [
  ...
  // ============ RECURRING: YOGA WITH ANNALISE (LAST SUNDAY OF MONTH) ============
  {
    ...
    recurrence: "Last Sunday of every month"
  },
  ...
  imageUrl: "/images/events/community/tantra.png",
  ...
  // ============ RECURRING: MILE HIGH QUALCHATA ============
  {
    ...
    imageUrl: "/images/events/dance/MHQ.PNG",
    imageFit: "contain",
