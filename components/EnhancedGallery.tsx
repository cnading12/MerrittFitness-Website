...
const EnhancedGallery = () => {
  ...
  const galleryItems = [
    ...
    {
      id: 31,
      src: "/images/events/venue/wellness/breathwork-class.webp",
    ...
    {
      id: 32,
      src: "/images/events/venue/wellness/breathwork-in-action.webp",
    ...
    {
      id: 34,
      src: "/images/events/venue/wellness/yoga-class.webp",
      title: "Yoga Class",
    ...
    {
      id: 29,
      src: "/images/events/venue/dance/Event-1.JPG",
    ...
    {
      id: 30,
      src: "/images/events/venue/dance/Event-2.JPG",
    ...
    <section className="py-20 bg-[#4a3f3c] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={goToPrev}
                className="p-2 bg-[#f2eee9]/10 text-[#f2eee9] hover:bg-[#f2eee9]/20 rounded-full backdrop-blur-sm transition-all"
              >
                <ChevronLeft size={20} />
              </button>
              <button
              ...
              >
                ...
                <div className="hidden md:block absolute inset-0 bg-gradient-to-t from-[#4a3f3c]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
                  <div className="absolute bottom-8 left-8 text-[#f2eee9] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <p className="text-[#f2eee9]/90 text-lg">{item.desc}</p>
                    {item.photographer && (
          ...
          <div className="fixed inset-0 z-[100] bg-[#4a3f3c]/95 flex items-center justify-center p-4">
            <div className="relative max-w-7xl max-h-full w-full h-full flex items-center justify-center">
              ...
              <div className="absolute top-4 right-4 z-10 flex gap-2">
                <button
                  onClick={goToPrev}
                  className="p-2 bg-[#4a3f3c]/50 text-[#f2eee9] hover:bg-[#4a3f3c]/70 rounded-full backdrop-blur-sm"
                >
                  <ChevronLeft size={24} />
                </button>
                <button
      ...
      <style jsx>{`
        .custom-scrollbar {
          ...
          scrollbar-color: rgba(242, 238, 233, 0.5) rgba(242, 238, 233, 0.1);
        }
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {
          background: rgba(242, 238, 233, 0.5);
          border-radius: 4px;
        }
        .custom-scrollbar::-webkit-scrollbar-thumb:hover {
          background: rgba(242, 238, 233, 0.7);
        }
      `}</style>
    </section>
  );
